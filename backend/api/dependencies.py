...
from infrastructure.notifications.websocket_notification_service import (
...
def get_task_queue() -> AsyncProcessingQueue:
    ...
    if _task_queue_instance is None:
        ...
        _task_queue_instance = AsyncProcessingQueue(
            page_processor=process_page_callback
        )
...
def get_cancel_job_use_case(
    ...
    return CancelJobUseCase(repository, task_queue, notification_service, storage)
