...
from api.dependencies import get_get_document_use_case, get_list_documents_use_case
...
async def get_document(
    job_id: str, use_case: GetDocumentUseCase = Depends(get_get_document_use_case)
):
    """
